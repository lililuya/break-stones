...
def cut_frame_use_moviepy(out_frame_dir, vid_path):
    if not os.path.exists(out_frame_dir):
        os.makedirs(out_frame_dir, exist_ok=True)
...
if __name__=="__main__":
    out_frame_dir = "/mnt/sdb/cxh/liwen/EAT_code/demo/mytest/gfpgan_restoration/o"
    res_path = "/mnt/sdb/cxh/liwen/EAT_code/demo/mytest/gfpgan_restoration/p"
